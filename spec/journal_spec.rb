  ...
  describe JournalParser do
    ...
    describe "#Parser" do
      ...
      it 'should parse a section' do
        ...
        html.should == "<div class='section'><div class='date'>3 April 2013</div><div class='entry'><p>Dear Journal...</p></div></div>"
      end
      ...
      it 'should parse multiple sections' do
        ...
        html.should == "<div class='section'><div class='date'>3 April 2013</div><div class='entry'><p><em>what up what up</em> yall </p></div></div><div class='section'><div class='date'>4 April 2013</div><div class='entry'><p>fuck <span class='textsc'>tha haters</span></p></div></div>"
      end
    ...
    describe "#JournalContainer" do
      ...
      it 'should allow me to whitelist someone to see the entire journal' do
        ...
        container.to_h.should == {
          :griffinmyers => "<div class='section'><div class='date'>3 April 2013</div><div class='entry'><p>Dear Journal...</p></div></div>"
        }
      end
