  ...
  describe LatexParser do
    ...
    describe "#Parser" do
      ...
      it 'should parse a section' do
        ...
        html.should == "<article><h1>3 April 2013</h1><div class='entry'><p>Dear Journal...</p></div></article>"
      end
      ...
      it 'should parse multiple sections' do
        ...
        html.should == "<article><h1>3 April 2013</h1><div class='entry'><p><em>what up what up</em> yall </p></div></article><article><h1>4 April 2013</h1><div class='entry'><p>fuck <span class='textsc'>tha haters</span></p></div></article>"
      end
    ...
    describe "#JournalContainer" do
      ...
      it 'should allow me to whitelist someone to see the entire journal' do
        ...
        container.to_h.should == {
          :griffinmyers => "<article><h1>3 April 2013</h1><div class='entry'><p>Dear Journal...</p></div></article>"
        }
      end
      ...
      it 'should allow me to whitelist multiple people to see the entire journal' do
        ...
        container.to_h.should == {
          :griffinmyers => "<article><h1>3 April 2013</h1><div class='entry'><p>Dear Journal...</p></div></article>",
          :roymuntz => "<article><h1>3 April 2013</h1><div class='entry'><p>Dear Journal...</p></div></article>"
        }
      end
      ...
      it 'should allow me to register multiple people and assign multiple, distinct posts to each' do
        ...
        container.to_h.should == {
          :roymuntz => "<article><h1>3 April 2013</h1><div class='entry'><p>Dear Journal... </p></div></article><article><h1>6 April 2013</h1><div class='entry'><p>Fuck Ernst...</p></div></article>",
          :etj=>"<article><h1>3 April 2013</h1><div class='entry'><p>Dear Journal... </p></div></article><article><h1>5 April 2013</h1><div class='entry'><p>Fuck The Munson... </p></div></article>"
        }
      end
